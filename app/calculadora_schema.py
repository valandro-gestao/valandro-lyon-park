    ...
    "COM_ALIQUOTA_CUMUL": {
        "campos": [
            ...
            },
            {
                ...
                "descricao": "Percentuais progressivos por faixa de valor do resultado, em vez de um percentual único. Alternativa ao Percentual de Aluguel — configure um dos dois. As faixas devem estar em ordem crescente. A última pode ficar sem limite.",
        ...
        "campos": [
            {
                ...
                "tipo_dado": "json", "natureza": "lista_estruturada",
                "obrigatorio": True, "default_tecnico": None,
                "descricao": "Percentuais progressivos aplicados por faixa de valor do resultado. As faixas devem estar em ordem crescente. A última pode ficar sem limite.",
                "editor": "tabela_editavel", "aceita_vigencia": True,
                "minimo_itens": 1,
                "estrutura_ordenada": {"campo_limite": "ate"},
                "item_schema": [
